...
if __name__ == '__main__':
  start   =  0#14  # start time
  stop    =  224#28  # end time
...
#          plt.scatter(ion_x[::space_2], ion_px[::space_2], c=color_list[1], s=marker_size, marker='.',alpha=0.8,label='carbon $p_x/m_ic$',zorder=2,lw=0)
      if 'Grid/Particles/subset_high_p/ion_s' in data.keys():
          ...
          condition = (ion_y**2+ion_z**2)**0.5<1.0
          ion_x  = ion_x[condition]
          ion_px = ion_px[condition]
          plt.scatter(ion_x[::space_2], ion_px[::space_2], c=color_list[2], s=marker_size, marker='.',alpha=0.8,label='ion_s $p_x/m_ic$',zorder=3,lw=0)
      print('hehe1')
