...
#    plt.subplot()
  ...
  pt3d=ax.scatter(grid_x[condition], grid_y[condition], grid_z[condition], c=color_index[condition], s=makersize*10, marker='.', cmap='magma', edgecolors='face', alpha=0.8,lw=0,norm=colors.Normalize(vmin=0,vmax=300))
...
#lt.figure(figsize=(100,100))
  ...
  fig.savefig(to_path+'new_ion_s_3d_scatter_Ek'+str(n).zfill(4)+'.png',format='png',dpi=160)
  plt.close("all")
