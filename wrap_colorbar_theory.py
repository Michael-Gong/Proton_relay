...
##below is for generating mid transparent colorbar
  ...
  c_blue = matplotlib.colors.colorConverter.to_rgba('deepskyblue')
  c_black = matplotlib.colors.colorConverter.to_rgba('chocolate')
  ...
  cmap_my_gw = matplotlib.colors.LinearSegmentedColormap.from_list('rb_cmap',[c_green,c_white_trans],128)
...
#    plt.close("all")
    ...
    cb1 = matplotlib.colorbar.ColorbarBase(ax1, cmap='jet', norm=colors.Normalize(vmin=0,vmax=20), 
                                    orientation='horizontal',ticks=[0,10,20])
    cb1.ax.xaxis.set_label_position('top'); cb1.ax.xaxis.set_ticks_position('top')
    cb1.ax.tick_params(labelsize=font_size) 
    cb1.set_label('$t\ [T_0]$',fontdict=font)
    plt.subplots_adjust(top=0.98, bottom=0.13, left=0.15, right=0.85, hspace=0.10, wspace=0.05)
    fig = plt.gcf()
    fig.set_size_inches(7, 2)
    plt.show()
    fig.savefig('./colorbar_fig/four_hami_trace_t.png',format='png',dpi=160, transparent=True)
    plt.close("all")

    fig = plt.figure()
    ax1 = fig.add_axes([0.1, 0.2, 0.5, 0.15])
    cb1 = matplotlib.colorbar.ColorbarBase(ax1, cmap=cmap_my_rw, norm=colors.Normalize(vmin=-0.50,vmax=-0.46), 
                                    orientation='horizontal',ticks=[-0.50,-0.48,-0.46])
    cb1.ax.xaxis.set_label_position('top'); cb1.ax.xaxis.set_ticks_position('top')
    cb1.ax.tick_params(labelsize=font_size) 
    cb1.set_label('$\mathcal{H}_4$ [$m_pc^2$]',fontdict=font)
    plt.subplots_adjust(top=0.98, bottom=0.13, left=0.15, right=0.85, hspace=0.10, wspace=0.05)
    fig = plt.gcf()
    fig.set_size_inches(7, 2)
    plt.show()
    fig.savefig('./colorbar_fig/four_hami_H4.png',format='png',dpi=160, transparent=True)
    plt.close("all")

    fig = plt.figure()
    ax1 = fig.add_axes([0.1, 0.2, 0.5, 0.15])
    cb1 = matplotlib.colorbar.ColorbarBase(ax1, cmap=cmap_my_gw, norm=colors.Normalize(vmin=-0.285,vmax=-0.24), 
                                    orientation='horizontal',ticks=[-0.28,-0.26,-0.24])
    cb1.ax.xaxis.set_label_position('top'); cb1.ax.xaxis.set_ticks_position('top')
    cb1.ax.tick_params(labelsize=font_size) 
    cb1.set_label('$\mathcal{H}_3$ [$m_pc^2$]',fontdict=font)
    plt.subplots_adjust(top=0.98, bottom=0.13, left=0.15, right=0.85, hspace=0.10, wspace=0.05)
    fig = plt.gcf()
    fig.set_size_inches(7, 2)
    plt.show()
    fig.savefig('./colorbar_fig/four_hami_H3.png',format='png',dpi=160, transparent=True)
    plt.close("all")

    fig = plt.figure()
    ax1 = fig.add_axes([0.1, 0.2, 0.5, 0.15])
    cb1 = matplotlib.colorbar.ColorbarBase(ax1, cmap=cmap_my_bw, norm=colors.Normalize(vmin=-0.1,vmax=-0.058), 
                                    orientation='horizontal',ticks=[-0.1,-0.08,-0.06])
    cb1.ax.xaxis.set_label_position('top'); cb1.ax.xaxis.set_ticks_position('top')
    cb1.ax.tick_params(labelsize=font_size) 
    ...
    fig.set_size_inches(7, 2)
    plt.show()
    fig.savefig('./colorbar_fig/four_hami_H2.png',format='png',dpi=160, transparent=True)
    plt.close("all")

    fig = plt.figure()
    ax1 = fig.add_axes([0.1, 0.2, 0.5, 0.15])
    cb1 = matplotlib.colorbar.ColorbarBase(ax1, cmap=cmap_my_kw, norm=colors.Normalize(vmin=-0.0050,vmax=0.0340), 
                                    orientation='horizontal',ticks=[0,0.015,0.03])
    cb1.ax.xaxis.set_label_position('top'); cb1.ax.xaxis.set_ticks_position('top')
    cb1.ax.tick_params(labelsize=font_size) 
    ...
    fig.set_size_inches(7, 2)
    plt.show()
    fig.savefig('./colorbar_fig/four_hami_H1.png',format='png',dpi=160, transparent=True)
    plt.close("all")
